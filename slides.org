...
Follow the [[https://json-schema.org/specification][specification]] and use this [[https://github.com/json-schema-org/JSON-Schema-Test-Suite/tree/main/tests/draft2020-12][test cases]] as a reference.

Try to start from the bottom and build up from it.
