...
TypeScript type system is (incidentally) more advanced than what you (probably)
think. TypeScript's type system is a full-fledged Turing-complete programming
language, limited, but powerful.
...
left (see: [[*Structural Typing, Subtyping & Assignability][Structural Typing, Subtyping & Assignability]]).
...
- [[file:snippets/unreacheable.ts][Snippet]] ([[https://www.typescriptlang.org/play/?#-v8TmcLld4DcQncHv8ni8oXlesZkHZKFAUXkGqFwpFVp15HMFksVmsch8vjsKL9HmigZjsbjwYT3ptYd9BPs+YCMSCcWD8RDXmKSWSKVSYGiAAJQCAAWgwoxUPkN1RAmV4znIDgwYFgJnyylUAAMmCx2FxCC6YGhsGAQLBxBA0OQwC1qPkLoZXekXC7HjSmnSMGzGUA][Playground]])
...
This means we are able to parse an arbitrary string 🤯.
...
#+BEGIN_SRC typescript :tangle snippets/toInternalPayload.ts
...
- [[file:snippets/toInternalPayload.ts][Snippet]] ([[https://www.typescriptlang.org/play/?#code/PTAEHUFNQCwQwG7QM6UgO1AFxgS2aAEaQBmA9gE6QBQIoADlVlrpBQLS4Dm6lNWAT3rQAyujgBrSABUyAYTgBbSABsAPCKwUAfKAC81UKE0VQkAB5YMAEwIADACQBvXOhJtQAMVwVkWAL4A+s6u7qYASpB+-naGoAD8oI5O3r4BzmKSMvJKqmoK9LhYcCq4AF6QapF+2toxcQBcxloA3NS0YFCwiNBUAI4ArlFYDHACKmRw1qAA7ngAxjCz0NZk6ADkI6VSRJDzcAOooK5WFOIqKgLHmGQDpvN8HaCrinCuy6CH0PuKyiqg+yO5FMOGgJFYKls1EEwlAkUGwwACmMJlN9KAnHFFnB6KdAiwsCpIE0-BRXFw2kYDjhKE0nKASAMLoFxMoSVpyaB-G1ue06F1VhsRjM4OgRlgyKAqDMfNBCFd4OhpiV-jSjv0hn5sEIos9JTNIPE+Z1vqK9ccRnBxTr2ESkP8ZThQABZHHCabSHXIY2gAAykCw6wIxR2RVAfkg9CIVwj9B9qS1VEIA1wkOwMGgFjg8xGyFyoDIhAAVntrbDRdMSEpU7g4GSKrMiktQeGBGK4OZoTrjLlkeNJtM9BjQABtADS11AUgEZBIcMgCL8fdR1gAuk14ZqsMuB+PV1y2k8uiKxdhJdj0FxoCr09Bp8Hz0o--igAAZMOI6IlhyE4dItGwxWuWIquui8tQFj0JQIz0iIvYNR+HECHBPEqHxyAfq1mXtXTr3vRWy1AA][Playground]])

You may have noticed something a little surprising about our ~ToInternalPayload~
implementation. We did not use a /Conditional Type/ to stop this type from
recursing indefinitely, it turns out that /Mapped Types/ already leave primitive
types unchanged.

** Mapped Types Dissected

/Mapped Types/ are often depicted as a syntax to map over each value of an
object type. The name "Mapped Type" directly comes from there, but what they do
really is to turn unions into objects;
...
// We can mix and match what we learned until now
type V = {
  [Letter in LetterUnion]: `This is the letter: ${Letter}`;
};
// type V = {
...
#+BEGIN_SRC typescript :tangle snippets/filteringKeys.ts
...
- [[file:snippets/filteringKeys.ts][Snippet]] ([[https://www.typescriptlang.org/play/?#-LrQBoiLARZQQQ8pODtpDBNC0QAlWDQSAikbwABEMRDiEosHIBCO4vg4B8CHEUZjR3OAH1wKB9byjSa6a8M+Icwb89jSAC5KAACoAeQAInXWu0EFHaILTABaAgkKVR+OgABCsA7sqWbpRSq2u2Iapud1dKxkOr1ZeNpoC3zp-0MKht8yIuCQCGySCyAC9YOdEzpk6nY+dtq8wwEQwCAXu7aAHU7DC6FQhKEDHaOF4BHMdKDlLVUQZVRLArNk8QmIkSUaJC8TQEJiTCdCQLAPEkASPC0Q5Qd6ybatf1MVp9QQPg+gUBEJ2XF5QElaVGCglinleCDeW4pFJxwaEgA][Playground]])

** Many More Things

- Add/remove optionality to/from a field
  - ~[K in keyof X]?~
  - ~[K in keyof X]-?~
- Add/remove reaonly modifier to/from a field
  - ~readonly [K in keyof X]~
  - ~-readonly [K in keyof X]~

** Exercises

#+BEGIN_SRC typescript :tangle snippets/toUppercase.ts
// eslint-disable-next-line
// @ts-nocheck
...
- [[file:snippets/toUppercase.ts][Snippet]] ([[https://www.typescriptlang.org/play/?#-A19IYAPzcMq-AFAxqGACy71AAF5QABvcigUAAQW8oAARJg8QBuDGgABCuLx2GJpM2lKYNMxABFKahGaAAKKU8DsgBilL67IA4pTYuyABKUljs3iU2DsgBSlIAVuyANKUjjsv6U6DsuGU-jsgBylPg7IA8pSGOyAAqUwTsgCKlIAjuyAEqUnTsgDKlMg7NUlMQ7I0lLk7IAapSAG7sgDqlL87IAGpSiOyAJqUyTsgBalKWNIAviTyJD1FpdCDwAAeAD6vogJDEqEm5lasQAfMi1BamRby5CPQAGACMfar9Vh9bxbGg0Bt3ZJlYnfY5RBkYzrHNdckw0DrY-HABp8eKOX8-ha8d2VxDpLIxwAmKeaGe1ut48XgRfL1cnzUUc3xRTdt0QXd90PY8QPPH8rxvO8HwrICxwAZnfatgSab870AmRgMwsCt3YSC9wPI8MPg5DhzQ0cABYsM-XC8W2RBWAYl8AEJ8NQwjVEYjdSJ3CiYLHBj4M2LFVE2cUuN4+86IEgcLT7QhYwaAjZHAsi61UFtxisSYWjkcBexRVRtM5aCj1Tc8sws0kAAp9O7ZyAEpkV7AziCM9tQFTUBQVASdcRfLy-LbSY3M87y1EM6LQCzYLQtAcLSUxELTPATL0v6Q9DHLYhBESU5UWAs9gJfc9BPQ2rGNq1Tav+QEcPhREy3IIA][Playground]])
- [[file:solutions/toUppercase.ts][Solution]] ([[https://www.typescriptlang.org/play/?#-wzkY6Cmg0xUhASQUIlmQtng0ewuFj8Xu8AAPPrQPAvRUhFU+KlLAA+V7g8eT6eCKo1AAk724+QSoEp4Z3e4P5HD7W+51A2-elInU5QG6zOcoecH8aLz2vH4riarlItKA-xHjuv7DiO5ALhe4LQgCVz9qAWoAAwAIyvPscZ--xCRNM0zqAI3jZNFANbNoC+gtoBLaAQngleGD0C1Z3AQU9HsFGk7QLY6CpvJLEUMJrG2V9aUUEVUpfYcBbDsWDZAA][Playground]])

#+BEGIN_SRC typescript :tangle snippets/settersAndGetters.ts
// eslint-disable-next-line
// @ts-nocheck
...
- [[file:snippets/settersAndGetters.ts][Snippet]] ([[https://www.typescriptlang.org/play/?#code/PTAEFMGcBsEsDsAuBaAJrSBDARtcz5wAPFOQgKBFAAFFICB7AYwAtwmBrcysAcVgBu4eKEwiG2AFbtEoAO6xELUADNY4aKkgAaUEwBO4TInCjQiAJ4AHUwqWhI4RCcij4qUAHMnJ-a5UM+uYsDI48quqakNxUABIAkgByACoAXKAWDACuemJ6DAC2VqHgwJIMCOZyDKAS0kx08orKAAYAZC358JCI+lkNgdyWNqAAyj7gfgCC8J68E34APAD6APIAfKAAvKDJqwAiqwDcQ9amAEoADACM22MLkDNzD4sA3sHgBeDpAERwnixED9QAAfUA-VCYfQcYEAX3WJ2GpmSNzuAFEiDYGotyKBQGiAI5ZTDQHF4vFXa7aXHk1408leJzJNhfdIACgAlNtNn9YACgaDwZDoT8Tgy8Y5EMzPt9QGyBCSsrLefzgWCIVCYVytpsBBVUGLybCaetyAjTiMrgAmO7jZyTR6zeb2pbveCYVkOXoITxHUTedLwLIFbCTUDwxFnXaXG07DFYxBk-FEklJikx6kMunixmIRIe2Wc7le-Q+w0MyX5z3yxWynql2ba3X68vk7yIKYBuVN0BBkOTVsSpydwsK6BKwPB0P6Ht62AG+nhk1mk7kJGgK4AZltDyezt8kDeEbXUZR27jmJki0JxNJW90r3h5pPIz2hzuhCE+kjI3jV+SEAkMIWjmH04CbDsyQ-qYN6pgAGroACaEGgAA2ghoCIQAuoBJjuK4qGIbocE4QA-KBSqgOkKgko4q7EMU+iyO8KJUtGVq6GenEHKs4YnEAA][Playground]])
- [[file:solutions/settersAndGetters.ts][Solution]] ([[https://www.typescriptlang.org/play/?#-u7p15PdbDUaTGZzRbLVbrTZsba7UBxCRHU7nS7XO4PZ5vT7QK4uWCOf5TV4-][Playground]])

* Final Challenge: JSON Schema to TypeScript

Convert a JSON spec known at compile time to the type of the object result of
the JSON spec validation when the input is valid.

Follow the [[https://json-schema.org/specification][specification]] and use this [[https://github.com/json-schema-org/JSON-Schema-Test-Suite/tree/main/tests/draft2020-12][test cases]] as a reference (another,
perhaps more approachable [[https://ajv.js.org/json-schema.html#json-schema-versions][reference]]) .


#+BEGIN_SRC typescript
const schema = {"type": "string"} as const;

type X = FromSchema<typeof schema>; // string
#+END_SRC

Try to start the bottom and compose from it, implement in order:
- primitive types ~{type: "number" | "integer" | "string" | "boolean" | "null"}~
- nullable ~{type: _, nullable: true}~
- array
- object
- enum
- const
...
* Final Challege: Type Safe MongoDB

Write a type that given the type definition of a MongoDB object will create a
type for the first argument of the the ~db.collection.find~ method representing
the query on those type of objects.

See the [[https://www.mongodb.com/docs/manual/reference/method/db.collection.find/#mongodb-method-db.collection.find][function documentation]] and [[https://www.mongodb.com/docs/manual/reference/operator/query/#std-label-query-projection-operators-top][the available operators]].

Start by taking a document type and add all the internal fields with the
corresponding path
...
* Final Challenge: Smart GET

#+BEGIN_SRC typescript :tangle snippets/smartGet.ts
// eslint-disable-next-line
// @ts-nocheck
...
- [[file:snippets/smartGet.ts][Snippet]] ([[https://www.typescriptlang.org/play/?#-][Playground]])
